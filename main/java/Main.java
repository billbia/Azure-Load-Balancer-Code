...
public class Main {
	...
	static {
		...
		instances[0] = new DataCenterInstance("First", "http://cloud-674883vm.eastus.cloudapp.azure.com");
		instances[1] = new DataCenterInstance("Second", "http://cloud-669819vm.eastus.cloudapp.azure.com");
		instances[2] = new DataCenterInstance("Third", "http://cloud-829454vm.eastus.cloudapp.azure.com");
	}
